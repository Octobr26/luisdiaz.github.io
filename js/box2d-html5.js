...
goog.base = function (a, b, c) {
    ...
    if (e.superClass_)
        return e.superClass_.constructor.apply(
            a,
...
box2d.b2MakeArray = function (a, b) {
    void 0 === a && (a = 0);
    var c = Array(a);
    if (void 0 !== b) for (var e = 0; e < a; ++e) c[e] = b(e);
    return c;
};
...
goog.exportProperty(
    box2d.b2Vec2.prototype,
    "GetLength",
    box2d.b2Vec2.prototype.GetLength
);
...
goog.exportProperty(
    box2d.b2Vec2.prototype,
    "SelfRotateRadians",
    box2d.b2Vec2.prototype.SelfRotateRadians
);
...
goog.exportProperty(
    box2d.b2Vec2.prototype,
    "SelfRotateDegrees",
    box2d.b2Vec2.prototype.SelfRotateDegrees
);
...
goog.exportProperty(
    box2d.b2Vec2.prototype,
    "SelfCrossVS",
    box2d.b2Vec2.prototype.SelfCrossVS
);
...
goog.exportProperty(
    box2d.b2Vec2.prototype,
    "SelfCrossSV",
    box2d.b2Vec2.prototype.SelfCrossSV
);
...
goog.exportProperty(
    box2d.b2Vec2.prototype,
    "SelfMinV",
    box2d.b2Vec2.prototype.SelfMinV
);
...
goog.exportProperty(
    box2d.b2Vec2.prototype,
    "SelfMaxV",
    box2d.b2Vec2.prototype.SelfMaxV
);
...
goog.exportProperty(
    box2d.b2Mat22.prototype,
    "SetSSSS",
    box2d.b2Mat22.prototype.SetSSSS
);
...
goog.exportProperty(
    box2d.b2Mat22.prototype,
    "SelfAddM",
    box2d.b2Mat22.prototype.SelfAddM
);
...
goog.exportProperty(
    box2d.b2Mat22.prototype,
    "SelfSubM",
    box2d.b2Mat22.prototype.SelfSubM
);
...
goog.exportProperty(
    box2d.b2Mat33.prototype,
    "SetVVV",
    box2d.b2Mat33.prototype.SetVVV
);
...
goog.exportProperty(
    box2d.b2Mat33.prototype,
    "SelfAddM",
    box2d.b2Mat33.prototype.SelfAddM
);
...
box2d.b2MulRR = function (a, b, c) {
    ...
    c.s = d * f + e * g;
    c.c = e * f - d * g;
    for (c.angle = a.angle + b.angle; c.angle < -box2d.b2_pi; )
...
goog.exportProperty(
    box2d.b2Transform.prototype,
    "SetPositionAngleRadians",
    box2d.b2Transform.prototype.SetPositionAngleRadians
);
...
goog.exportProperty(
    ...
    box2d.b2Transform.prototype.SetRotationAngleRadians
);
...
box2d.b2ConstantAccelController.prototype.Step = function (a) {
    ...
    for (var b = this.m_bodyList; b; b = b.nextBody) {
        ...
        c.IsAwake() &&
            c.SetLinearVelocity(
                box2d.b2AddVV(c.GetLinearVelocity(), a, box2d.b2Vec2.s_t0)
            );
    }
};
goog.exportProperty(
...
box2d.b2RevoluteJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    var h = this.m_invMassA,
        ...
        n = 0 === k + m;
    this.m_mass.ex.x =
        h + l + this.m_rA.y * this.m_rA.y * k + this.m_rB.y * this.m_rB.y * m;
    this.m_mass.ey.x =
        -this.m_rA.y * this.m_rA.x * k - this.m_rB.y * this.m_rB.x * m;
    this.m_mass.ez.x = -this.m_rA.y * k - this.m_rB.y * m;
    this.m_mass.ex.y = this.m_mass.ey.x;
    this.m_mass.ey.y =
        h + l + this.m_rA.x * this.m_rA.x * k + this.m_rB.x * this.m_rB.x * m;
    ...
    a.step.warmStarting
        ? (this.m_impulse.SelfMul(a.step.dtRatio),
          ...
          (b =
              box2d.b2RevoluteJoint.prototype.InitVelocityConstraints.s_P.SetXY(
                  this.m_impulse.x,
                  this.m_impulse.y
              )),
          c.SelfMulSub(h, b),
          (e -=
              k *
              (box2d.b2CrossVV(this.m_rA, b) +
                  this.m_motorImpulse +
                  this.m_impulse.z)),
          f.SelfMulAdd(l, b),
          (g +=
              m *
              (box2d.b2CrossVV(this.m_rB, b) +
                  this.m_motorImpulse +
                  this.m_impulse.z)))
...
box2d.b2RevoluteJoint.prototype.InitVelocityConstraints.s_P =
    new box2d.b2Vec2();
box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints = function (a) {
    ...
    !1 === k
        ? ((k = box2d.b2SubVV(
              box2d.b2AddVCrossSV(e, d, this.m_rB, box2d.b2Vec2.s_t0),
          ...
          this.m_limitState === box2d.b2LimitState.e_equalLimits
              ...
              ? ((n = this.m_impulse.z + m.z),
                0 > n
                    ? ((n = -k.x + this.m_impulse.z * this.m_mass.ez.x),
                      (k = -k.y + this.m_impulse.z * this.m_mass.ez.y),
                      (k = this.m_mass.Solve22(
                          n,
                          k,
                          box2d.b2RevoluteJoint.prototype
                              .SolveVelocityConstraints.s_reduced
                      )),
                      (m.x = k.x),
                      (m.y = k.y),
              ...
              : this.m_limitState === box2d.b2LimitState.e_atUpperLimit &&
                ...
                0 < n
                    ...
                    : this.m_impulse.SelfAdd(m)),
          (k =
              box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_P.SetXY(
                  m.x,
                  m.y
              )),
          b.SelfMulSub(f, k),
        ...
        : ((m = box2d.b2SubVV(
          ...
          b.SelfMulSub(f, m),
          (c -= h * box2d.b2CrossVV(this.m_rA, m)),
          e.SelfMulAdd(g, m),
          (d += l * box2d.b2CrossVV(this.m_rB, m)));
...
box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_P =
    new box2d.b2Vec2();
box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_Cdot =
    new box2d.b2Vec2();
box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_Cdot1 =
...
box2d.b2RevoluteJoint.prototype.SolvePositionConstraints = function (a) {
    ...
    if (
        ...
        this.m_limitState === box2d.b2LimitState.e_equalLimits
            ...
            ? ((k -= this.m_lowerAngle),
              (h = -k),
              (k = box2d.b2Clamp(
                  k + box2d.b2_angularSlop,
                  -box2d.b2_maxAngularCorrection,
                  0
              )),
              (l = -this.m_motorMass * k))
            : this.m_limitState === box2d.b2LimitState.e_atUpperLimit &&
              ((h = k -= this.m_upperAngle),
              (k = box2d.b2Clamp(
                  k - box2d.b2_angularSlop,
                  0,
                  box2d.b2_maxAngularCorrection
    ...
    var g = box2d.b2MulRV(g, this.m_lalcB, this.m_rB),
        k = box2d.b2SubVV(
            box2d.b2AddVV(e, g, box2d.b2Vec2.s_t0),
            box2d.b2AddVV(b, f, box2d.b2Vec2.s_t1),
...
goog.exportProperty(
    ...
    box2d.b2RevoluteJoint.prototype.GetJointAngleRadians
);
...
box2d.b2PrismaticJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    var m = box2d.b2MulRV(f, this.m_lalcB, this.m_rB),
        n = box2d.b2AddVV(
            ...
            box2d.b2SubVV(m, k, box2d.b2Vec2.s_t1),
    ...
    this.m_a1 = box2d.b2CrossVV(
        box2d.b2AddVV(n, k, box2d.b2Vec2.s_t0),
        this.m_axis
    );
    this.m_a2 = box2d.b2CrossVV(m, this.m_axis);
    this.m_motorMass =
        b + d + f * this.m_a1 * this.m_a1 + p * this.m_a2 * this.m_a2;
    0 < this.m_motorMass && (this.m_motorMass = 1 / this.m_motorMass);
    ...
    this.m_K.ex.x =
        b + d + f * this.m_s1 * this.m_s1 + p * this.m_s2 * this.m_s2;
...
box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints = function (a) {
    ...
    if (
        ...
        var k =
                box2d.b2DotVV(
                    this.m_axis,
                    box2d.b2SubVV(e, b, box2d.b2Vec2.s_t0)
                ) +
                this.m_a2 * d -
                this.m_a1 * c,
    ...
    var n =
            box2d.b2DotVV(this.m_perp, box2d.b2SubVV(e, b, box2d.b2Vec2.s_t0)) +
            this.m_s2 * d -
            this.m_s1 * c,
        p = d - c;
    this.m_enableLimit &&
    this.m_limitState !== box2d.b2LimitState.e_inactiveLimit
        ? ((k =
              ...
              this.m_a1 * c),
          (m =
              box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_f1.Copy(
                  this.m_impulse
              )),
          (k = this.m_K.Solve33(
              -n,
          ...
          (k.x = this.m_impulse.x - m.x),
          (k.y = this.m_impulse.y - m.y),
          (k.z = this.m_impulse.z - m.z),
          (m = box2d.b2AddVV(
              box2d.b2MulSV(k.x, this.m_perp, box2d.b2Vec2.s_t0),
              box2d.b2MulSV(k.z, this.m_axis, box2d.b2Vec2.s_t1),
              box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_P
          )),
          (n = k.x * this.m_s1 + k.y + k.z * this.m_a1),
...
box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_f2r =
    new box2d.b2Vec2();
box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_f1 =
    new box2d.b2Vec3();
box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_df3 =
    new box2d.b2Vec3();
box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_df2 =
...
box2d.b2PrismaticJoint.prototype.SolvePositionConstraints = function (a) {
    var b = a.positions[this.m_indexA].c,
        ...
        q = box2d.b2SubVV(
            box2d.b2AddVV(e, p, box2d.b2Vec2.s_t0),
    ...
    if (x) {
        ...
        (q = k * s + m * u),
            ...
            (v.z = 0);
    r = box2d.b2AddVV(
        box2d.b2MulSV(v.x, f, box2d.b2Vec2.s_t0),
        box2d.b2MulSV(v.z, r, box2d.b2Vec2.s_t1),
...
box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_d =
    new box2d.b2Vec2();
box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_impulse =
    new box2d.b2Vec3();
...
box2d.b2PrismaticJoint.prototype.GetJointSpeed = function () {
    ...
    return (
        box2d.b2DotVV(d, box2d.b2CrossSV(a, f, box2d.b2Vec2.s_t0)) +
        box2d.b2DotVV(
            f,
            box2d.b2SubVV(
                box2d.b2AddVCrossSV(h, b, e, box2d.b2Vec2.s_t0),
                box2d.b2AddVCrossSV(g, a, c, box2d.b2Vec2.s_t1),
                box2d.b2Vec2.s_t0
            )
        )
    );
...
box2d.b2GearJoint = function (a) {
    ...
    this.m_typeA === box2d.b2JointType.e_revoluteJoint
        ? ((c = a.joint1),
          ...
          (b = e - d - this.m_referenceAngleA))
        : ((d = a.joint1),
          this.m_localAnchorC.Copy(d.m_localAnchorA),
          this.m_localAnchorA.Copy(d.m_localAnchorB),
          (this.m_referenceAngleA = d.m_referenceAngle),
          this.m_localAxisC.Copy(d.m_localXAxisA),
          (e = this.m_localAnchorC),
          (b = box2d.b2MulTRV(
              c.q,
              box2d.b2AddVV(
                  box2d.b2MulRV(b.q, this.m_localAnchorA, box2d.b2Vec2.s_t0),
                  box2d.b2SubVV(b.p, c.p, box2d.b2Vec2.s_t1),
                  box2d.b2Vec2.s_t0
              ),
              box2d.b2Vec2.s_t0
          )),
          (b = box2d.b2DotVV(
              box2d.b2SubVV(b, e, box2d.b2Vec2.s_t0),
              this.m_localAxisC
          )));
    ...
    this.m_typeB === box2d.b2JointType.e_revoluteJoint
        ? ((c = a.joint2),
          ...
          (c = d - f - this.m_referenceAngleB))
        : ((d = a.joint2),
          this.m_localAnchorD.Copy(d.m_localAnchorA),
          this.m_localAnchorB.Copy(d.m_localAnchorB),
          (this.m_referenceAngleB = d.m_referenceAngle),
          this.m_localAxisD.Copy(d.m_localXAxisA),
          (d = this.m_localAnchorD),
          (c = box2d.b2MulTRV(
              e.q,
              box2d.b2AddVV(
                  box2d.b2MulRV(c.q, this.m_localAnchorB, box2d.b2Vec2.s_t0),
                  box2d.b2SubVV(c.p, e.p, box2d.b2Vec2.s_t1),
                  box2d.b2Vec2.s_t0
              ),
              box2d.b2Vec2.s_t0
          )),
          (c = box2d.b2DotVV(
              box2d.b2SubVV(c, d, box2d.b2Vec2.s_t0),
              this.m_localAxisD
          )));
...
box2d.b2GearJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    this.m_typeA === box2d.b2JointType.e_revoluteJoint
        ...
        : ((k = box2d.b2MulRV(
          ...
          this.m_JvAC.Copy(k),
          (this.m_JwC = box2d.b2CrossVV(q, k)),
          (this.m_JwA = box2d.b2CrossVV(p, k)),
          (this.m_mass +=
              this.m_mC +
              this.m_mA +
    ...
    this.m_typeB === box2d.b2JointType.e_revoluteJoint
        ...
        : ((k = box2d.b2MulRV(
          ...
          box2d.b2MulSV(this.m_ratio, k, this.m_JvBD),
          (this.m_JwD = this.m_ratio * box2d.b2CrossVV(p, k)),
          (this.m_JwB = this.m_ratio * box2d.b2CrossVV(e, k)),
          (this.m_mass +=
    ...
    a.step.warmStarting
        ? (b.SelfMulAdd(this.m_mA * this.m_impulse, this.m_JvAC),
          ...
          d.SelfMulAdd(this.m_mB * this.m_impulse, this.m_JvBD),
...
box2d.b2GearJoint.prototype.SolveVelocityConstraints = function (a) {
    var b = a.velocities[this.m_indexA].v,
        ...
        k =
            ...
            box2d.b2DotVV(this.m_JvBD, box2d.b2SubVV(e, h, box2d.b2Vec2.s_t0)),
        k =
            k +
            (this.m_JwA * c -
                this.m_JwC * g +
                (this.m_JwB * d - this.m_JwD * l)),
        k = -this.m_mass * k;
    this.m_impulse += k;
...
box2d.b2GearJoint.prototype.SolvePositionConstraints = function (a) {
    ...
    if (this.m_typeA === box2d.b2JointType.e_revoluteJoint)
        ...
        n = box2d.b2MulTRV(
            ...
            box2d.b2AddVV(
                v,
                box2d.b2SubVV(b, f, box2d.b2Vec2.s_t0),
                box2d.b2Vec2.s_t0
            ),
            box2d.b2Vec2.s_t0
        );
        n = box2d.b2DotVV(
            box2d.b2SubVV(n, s, box2d.b2Vec2.s_t0),
            this.m_localAxisC
        );
    }
    if (this.m_typeB === box2d.b2JointType.e_revoluteJoint)
        ...
        p = box2d.b2MulTRV(
            ...
            box2d.b2AddVV(
                v,
                box2d.b2SubVV(e, h, box2d.b2Vec2.s_t0),
                box2d.b2Vec2.s_t0
            ),
            box2d.b2Vec2.s_t0
        );
        p = box2d.b2DotVV(
            box2d.b2SubVV(p, y, box2d.b2Vec2.s_t0),
            this.m_localAxisD
        );
    }
...
box2d.b2DistanceProxy.prototype.GetSupport = function (a) {
    for (
        var b = 0, c = box2d.b2DotVV(this.m_vertices[0], a), e = 1;
        e < this.m_count;
        ++e
    ) {
...
box2d.b2DistanceProxy.prototype.GetSupportVertex = function (a, b) {
    for (
        var c = 0, e = box2d.b2DotVV(this.m_vertices[0], a), d = 1;
        d < this.m_count;
        ++d
    ) {
...
box2d.b2Simplex.prototype.GetSearchDirection = function (a) {
    switch (this.m_count) {
        ...
        case 2:
            ...
            return 0 <
                box2d.b2CrossVV(b, box2d.b2NegV(this.m_v1.w, box2d.b2Vec2.s_t0))
                ? box2d.b2CrossOneV(b, a)
                : box2d.b2CrossVOne(b, a);
        default:
...
box2d.b2Distance = function (a, b, c) {
    ...
    for (
        ...
        r = l[h.m_count];
        r.indexA = e.GetSupport(
            box2d.b2MulTRV(
                f.q,
                box2d.b2NegV(q, box2d.b2Vec2.s_t0),
                box2d.b2Distance.s_supportA
            )
        );
        box2d.b2MulXV(f, e.GetVertex(r.indexA), r.wA);
        r.indexB = d.GetSupport(
            box2d.b2MulTRV(g.q, q, box2d.b2Distance.s_supportB)
        );
    ...
    c.useRadii &&
        ((b = e.m_radius),
        (d = d.m_radius),
        a.distance > b + d && a.distance > box2d.b2_epsilon
            ? ((a.distance -= b + d),
              (c = box2d.b2SubVV(
                  a.pointB,
                  a.pointA,
                  box2d.b2Distance.s_normal
              )),
              c.Normalize(),
              a.pointA.SelfMulAdd(b, c),
              a.pointB.SelfMulSub(d, c))
            : ((r = box2d.b2MidVV(a.pointA, a.pointB, box2d.b2Distance.s_p)),
              a.pointA.Copy(r),
              a.pointB.Copy(r),
              (a.distance = 0)));
};
...
box2d.b2WeldJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    a.step.warmStarting
        ? (this.m_impulse.SelfMul(a.step.dtRatio),
          (n = box2d.b2WeldJoint.prototype.InitVelocityConstraints.s_P.SetXY(
              this.m_impulse.x,
              this.m_impulse.y
          )),
          c.SelfMulSub(h, n),
          (e -= k * (box2d.b2CrossVV(this.m_rA, n) + this.m_impulse.z)),
          f.SelfMulAdd(l, n),
          (g += m * (box2d.b2CrossVV(this.m_rB, n) + this.m_impulse.z)))
        : this.m_impulse.SetZero();
    a.velocities[this.m_indexA].w = e;
    a.velocities[this.m_indexB].w = g;
};
...
box2d.b2WeldJoint.prototype.SolveVelocityConstraints = function (a) {
    ...
    if (0 < this.m_frequencyHz) {
        var k =
            -this.m_mass.ez.z *
            (d - c + this.m_bias + this.m_gamma * this.m_impulse.z);
        this.m_impulse.z += k;
        c -= h * k;
        d += l * k;
        k = box2d.b2SubVV(
        ...
        var k = box2d.b2SubVV(
            ...
            m = box2d
                ...
                .SelfNeg();
        this.m_impulse.SelfAdd(m);
        k = box2d.b2WeldJoint.prototype.SolveVelocityConstraints.s_P.SetXY(
            m.x,
            m.y
        );
        b.SelfMulSub(f, k);
    ...
    if (0 < this.m_frequencyHz) {
        ...
        (r = box2d.b2SubVV(
            ...
            (n = q
                ...
                .SelfNeg()),
            (q = box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_P.SetXY(
                n.x,
                n.y
            )),
            b.SelfMulSub(h, q),
            (c -= k * (box2d.b2CrossVV(this.m_rA, q) + n.z)),
            e.SelfMulAdd(l, q),
            (d += m * (box2d.b2CrossVV(this.m_rB, q) + n.z));
    a.positions[this.m_indexA].a = c;
    a.positions[this.m_indexB].a = d;
...
box2d.b2RopeJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    this.m_length > box2d.b2_linearSlop
        ? (this.m_u.SelfMul(1 / this.m_length),
          ...
          (d = box2d.b2CrossVV(this.m_rB, this.m_u)),
          (b =
              this.m_invMassA +
              this.m_invIA * b * b +
              this.m_invMassB +
          ...
          a.step.warmStarting
              ? ((this.m_impulse *= a.step.dtRatio),
                ...
                (e -= this.m_invIA * box2d.b2CrossVV(this.m_rA, b)),
                g.SelfMulAdd(this.m_invMassB, b),
                (h += this.m_invIB * box2d.b2CrossVV(this.m_rB, b)))
              : (this.m_impulse = 0),
          (a.velocities[this.m_indexA].w = e),
          (a.velocities[this.m_indexB].w = h))
        ...
        for (a = this.m_bodyList; a; a = a.nextBody)
            for (
                ...
                var f = d.body,
                    ...
                    m = l * l + k * k;
                m < box2d.b2_epsilon ||
                    ((l = box2d.b2GravityController.prototype.Step.s_f.SetXY(
                        l,
                        k
                    )),
                    l.SelfMul((this.G / m / box2d.b2Sqrt(m)) * e * h),
        ...
        for (a = this.m_bodyList; a; a = a.nextBody)
            for (
                ...
                (f = d.body),
                    ...
                    m < box2d.b2_epsilon ||
                        ((l =
                            box2d.b2GravityController.prototype.Step.s_f.SetXY(
                                l,
                                k
                            )),
                        l.SelfMul((this.G / m) * e * h),
                        b.IsAwake() && b.ApplyForce(l, c),
                        f.IsAwake() && f.ApplyForce(l.SelfMul(-1), g));
};
goog.exportProperty(
...
goog.exportProperty(
    ...
    "_id",
    box2d.b2ContactFeature.prototype._id
);
...
Object.defineProperty(box2d.b2ContactFeature.prototype, "indexB", {
    ...
    set: function (a) {
        this._indexB = a;
        this._id._key =
            (this._id._key & 4294902015) | ((this._indexB << 8) & 65280);
    }
});
Object.defineProperty(box2d.b2ContactFeature.prototype, "typeA", {
    ...
    set: function (a) {
        this._typeA = a;
        this._id._key =
            (this._id._key & 4278255615) | ((this._typeA << 16) & 16711680);
    }
});
Object.defineProperty(box2d.b2ContactFeature.prototype, "typeB", {
    ...
    set: function (a) {
        this._typeB = a;
        this._id._key =
            (this._id._key & 16777215) | ((this._typeB << 24) & 4278190080);
    }
});
    ...
    if (0 !== a.pointCount)
        switch (a.type) {
            case box2d.b2ManifoldType.e_circles:
                ...
                box2d.b2DistanceSquaredVV(b, a) > box2d.b2_epsilon_sq &&
                    box2d.b2SubVV(a, b, this.normal).SelfNormalize();
                var f = box2d.b2AddVMulSV(
                        b,
                        c,
                        this.normal,
                ...
                this.separations[0] = box2d.b2DotVV(
                    box2d.b2SubVV(g, f, box2d.b2Vec2.s_t0),
                    this.normal
                );
                break;
                ...
                for (
                    ...
                    var m = box2d.b2MulXV(
                        ...
                        f =
                            c -
                            box2d.b2DotVV(
                                box2d.b2SubVV(m, h, box2d.b2Vec2.s_t0),
                                this.normal
                            ),
                        f = box2d.b2AddVMulSV(
                            m,
                    ...
                    this.separations[l] = box2d.b2DotVV(
                        box2d.b2SubVV(g, f, box2d.b2Vec2.s_t0),
                        this.normal
                    );
                }
            ...
            case box2d.b2ManifoldType.e_faceB:
                ...
                for (k = a.pointCount; l < k; ++l)
                    (m = box2d.b2MulXV(
                        ...
                        box2d.b2MidVV(f, g, this.points[l]),
                        (this.separations[l] = box2d.b2DotVV(
                            box2d.b2SubVV(f, g, box2d.b2Vec2.s_t0),
                            this.normal
                        ));
                this.normal.SelfNeg();
        }
...
box2d.b2AABB.prototype.RayCast = function (a, b) {
    ...
    if (l < box2d.b2_epsilon) {
        ...
        ((l = 1 / g),
        (g = (this.lowerBound.x - d) * l),
        (d = (this.upperBound.x - d) * l),
        (l = -1),
        g > d && ((l = g), (g = d), (d = l), (l = 1)),
        g > c && ((m.x = l), (m.y = 0), (c = g)),
        (e = box2d.b2Min(e, d)),
    ...
    if (k < box2d.b2_epsilon) {
        ...
        ((l = 1 / h),
        (g = (this.lowerBound.y - f) * l),
        (d = (this.upperBound.y - f) * l),
        (l = -1),
        g > d && ((l = g), (g = d), (d = l), (l = 1)),
        g > c && ((m.x = 0), (m.y = l), (c = g)),
        (e = box2d.b2Min(e, d)),
...
box2d.b2ClipSegmentToLine = function (a, b, c, e, d) {
    ...
    0 > h * c &&
        ((c = h / (h - c)),
        (e = a[f].v),
        (e.x = g.v.x + c * (b.v.x - g.v.x)),
        (e.y = g.v.y + c * (b.v.y - g.v.y)),
        (a = a[f].id),
        (a.cf.indexA = d),
...
box2d.b2SeparationFunction.prototype.Initialize = function (a, b, c, e, d, f) {
    ...
    1 === b
        ? ((this.m_type = box2d.b2SeparationFunctionType.e_points),
          ...
          (c = box2d.b2MulXV(c, b, box2d.b2TimeOfImpact.s_pointA)),
          (d = box2d.b2MulXV(d, a, box2d.b2TimeOfImpact.s_pointB)),
          box2d.b2SubVV(d, c, this.m_axis),
        ...
        : (a.indexA[0] === a.indexA[1]
              ? ((this.m_type = box2d.b2SeparationFunctionType.e_faceB),
                ...
                (e = this.m_proxyB.GetVertex(a.indexB[1])),
                box2d
                    .b2CrossVOne(
                        box2d.b2SubVV(e, b, box2d.b2Vec2.s_t0),
                        this.m_axis
                ...
                box2d.b2MidVV(b, e, this.m_localPoint),
                (d = box2d.b2MulXV(
                    d,
                    this.m_localPoint,
                ...
                (b = this.m_proxyA.GetVertex(a.indexA[0])),
                (c = box2d.b2MulXV(c, b, box2d.b2TimeOfImpact.s_pointA)),
                (a = box2d.b2DotVV(box2d.b2SubVV(c, d, box2d.b2Vec2.s_t0), f)))
              : ((this.m_type = box2d.b2SeparationFunctionType.e_faceA),
                ...
                (a = this.m_proxyB.GetVertex(a.indexB[0])),
                (d = box2d.b2MulXV(d, a, box2d.b2TimeOfImpact.s_pointB)),
                (a = box2d.b2DotVV(box2d.b2SubVV(d, c, box2d.b2Vec2.s_t0), f))),
...
box2d.b2SeparationFunction.prototype.FindMinSeparation = function (a, b, c) {
    ...
    switch (this.m_type) {
        case box2d.b2SeparationFunctionType.e_points:
            ...
            return (b = box2d.b2DotVV(
                box2d.b2SubVV(d, e, box2d.b2Vec2.s_t0),
                this.m_axis
            ));
        case box2d.b2SeparationFunctionType.e_faceA:
            return (
                ...
                (g = box2d.b2MulTRV(
                    d.q,
                    box2d.b2NegV(c, box2d.b2Vec2.s_t0),
                    box2d.b2TimeOfImpact.s_axisB
                )),
                (a[0] = -1),
                (b[0] = this.m_proxyB.GetSupport(g)),
                (b = this.m_proxyB.GetVertex(b[0])),
                (d = box2d.b2MulXV(d, b, box2d.b2TimeOfImpact.s_pointB)),
                (b = box2d.b2DotVV(box2d.b2SubVV(d, e, box2d.b2Vec2.s_t0), c))
            );
    ...
    switch (this.m_type) {
        ...
        case box2d.b2SeparationFunctionType.e_faceA:
            return (
                ...
                (b = this.m_proxyB.GetVertex(b)),
                (d = box2d.b2MulXV(d, b, box2d.b2TimeOfImpact.s_pointB)),
                (e = box2d.b2DotVV(box2d.b2SubVV(d, e, box2d.b2Vec2.s_t0), c))
            );
        case box2d.b2SeparationFunctionType.e_faceB:
            return (
                (c = box2d.b2MulRV(
...
box2d.b2TimeOfImpact = function (a, b) {
    ...
    var h = b.tMax,
        l = box2d.b2Max(
            box2d.b2_linearSlop,
            e.m_radius + d.m_radius - 3 * box2d.b2_linearSlop
        ),
...
goog.exportProperty(
    ...
    "m_flags",
    box2d.b2Contact.prototype.m_flags
);
...
goog.exportProperty(
    ...
    "Reset",
    box2d.b2PolygonAndCircleContact.prototype.Reset
);
...
goog.exportProperty(
    ...
    "Reset",
    box2d.b2EdgeAndPolygonContact.prototype.Reset
);
box2d.b2EdgeAndPolygonContact.prototype.Evaluate = function (a, b, c) {
    ...
    box2d.b2CollideEdgeAndPolygon(
        a,
        e instanceof box2d.b2EdgeShape ? e : null,
        b,
...
box2d.b2PolygonShape.prototype.Set = function (a, b) {
    ...
    for (
        var c = box2d.b2Min(b, box2d.b2_maxPolygonVertices),
            e = box2d.b2PolygonShape.prototype.Set.s_ps,
            d = 0,
            f = 0;
        f < c;
        ++f
        ...
        for (var g = a[f], h = !0, l = 0; l < d; ++l)
            if (
                box2d.b2DistanceSquaredVV(g, e[l]) <
                0.5 * box2d.b2_linearSlop
            ) {
                h = !1;
                break;
            }
    ...
    g = e[0].x;
    for (f = 1; f < c; ++f)
        if (((l = e[f].x), l > g || (l === g && e[f].y < e[d].y)))
            (d = f), (g = l);
    for (var k = box2d.b2PolygonShape.prototype.Set.s_hull, h = 0, f = d; ; ) {
        ...
        for (var m = 0, l = 1; l < c; ++l)
            if (m === f) m = l;
                ...
                0 > p && (m = l);
                0 === p &&
                    g.GetLengthSquared() > n.GetLengthSquared() &&
                    (m = l);
            }
        ++h;
        f = m;
    ...
    for (c = h; f < c; ++f)
        (e = box2d.b2SubVV(
            this.m_vertices[(f + 1) % c],
            this.m_vertices[f],
            box2d.b2Vec2.s_t0
        )),
            box2d.ENABLE_ASSERTS &&
                box2d.b2Assert(e.GetLengthSquared() > box2d.b2_epsilon_sq),
            box2d.b2CrossVOne(e, this.m_normals[f]).SelfNormalize();
...
goog.exportProperty(
    box2d.b2PolygonShape.prototype,
    "SetAsVector",
    box2d.b2PolygonShape.prototype.SetAsVector
);
...
goog.exportProperty(
    box2d.b2PolygonShape.prototype,
    "SetAsArray",
    box2d.b2PolygonShape.prototype.SetAsArray
);
...
box2d.b2PolygonShape.prototype.TestPoint = function (a, b) {
    for (
        ...
        if (
            ...
            box2d.b2DotVV(
                this.m_normals[e],
                box2d.b2SubVV(c, this.m_vertices[e], box2d.b2Vec2.s_t0)
            )
        )
            return !1;
    return !0;
...
box2d.b2PolygonShape.prototype.RayCast = function (a, b, c, e) {
    ...
    for (
        var d = box2d.b2MulTXV(
            ...
            d = box2d.b2SubVV(d, e, box2d.b2PolygonShape.prototype.RayCast.s_d),
            f = 0,
            g = b.maxFraction,
            h = -1,
            l = 0,
        ...
        var m = box2d.b2DotVV(
                this.m_normals[l],
                box2d.b2SubVV(this.m_vertices[l], e, box2d.b2Vec2.s_t0)
            ),
    ...
    return 0 <= h
        ? ((a.fraction = f),
          box2d.b2MulRV(c.q, this.m_normals[h], a.normal),
          !0)
        : !1;
};
goog.exportProperty(
...
box2d.b2PolygonShape.prototype.ComputeMass = function (a, b) {
    ...
    for (var l = 1 / 3, g = 0, h = this.m_count; g < h; ++g) {
        ...
        c.SelfAdd(
            box2d.b2MulSV(
                p * l,
                box2d.b2AddVV(k, m, box2d.b2Vec2.s_t0),
                box2d.b2Vec2.s_t1
            )
        );
        var p = k.x,
...
box2d.b2PolygonShape.prototype.ComputeSubmergedArea = function (a, b, c, e) {
    ...
    switch (h) {
        case 0:
            return k
                ? ((a =
                      box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_md),
                  this.ComputeMass(a, 1),
                  box2d.b2MulXV(c, a.center, e),
                  a.mass)
                : 0;
        case 1:
    ...
    f = (0 - g[l]) / (g[a] - g[l]);
    g = (0 - g[b]) / (g[d] - g[b]);
    l = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_intoVec.SetXY(
        this.m_vertices[l].x * (1 - f) + this.m_vertices[a].x * f,
        this.m_vertices[l].y * (1 - f) + this.m_vertices[a].y * f
    );
    b = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_outoVec.SetXY(
        this.m_vertices[b].x * (1 - g) + this.m_vertices[d].x * g,
        this.m_vertices[b].y * (1 - g) + this.m_vertices[d].y * g
    );
    g = 0;
    ...
    for (k = null; a !== d; )
        (a = (a + 1) % this.m_count),
            (k = a === d ? b : this.m_vertices[a]),
            (m = 0.5 * ((h.x - l.x) * (k.y - l.y) - (h.y - l.y) * (k.x - l.x))),
            (g += m),
            (f.x += (m * (l.x + h.x + k.x)) / 3),
            (f.y += (m * (l.y + h.y + k.y)) / 3),
            (h = k);
...
box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_normalL =
    new box2d.b2Vec2();
box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_depths =
    box2d.b2MakeNumberArray(box2d.b2_maxPolygonVertices);
box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_md =
    new box2d.b2MassData();
box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_intoVec =
    new box2d.b2Vec2();
box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_outoVec =
    new box2d.b2Vec2();
box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_center =
    new box2d.b2Vec2();
...
box2d.b2PolygonShape.ComputeCentroid = function (a, b, c) {
    ...
    for (
        var e = 0,
            d = box2d.b2PolygonShape.ComputeCentroid.s_pRef.SetZero(),
            f = 1 / 3,
            g = 0;
        g < b;
        ++g
...
box2d.b2CollideEdgeAndCircle = function (a, b, c, e, d) {
    ...
    c = box2d.b2MulTXV(
        c,
        box2d.b2MulXV(d, e.m_p, box2d.b2Vec2.s_t0),
    ...
    if (0 >= k) {
        var n = f,
            l = box2d.b2SubVV(c, n, box2d.b2CollideEdgeAndCircle.s_d),
            l = box2d.b2DotVV(l, l);
        if (!(l > m * m)) {
            if (
                b.m_hasVertex0 &&
                ...
                0 < box2d.b2DotVV(b, box2d.b2SubVV(f, c, box2d.b2Vec2.s_t0)))
            )
                return;
            d.cf.indexA = 0;
        ...
        if (
            ...
            if (
                ...
                0 < box2d.b2DotVV(f, box2d.b2SubVV(c, g, box2d.b2Vec2.s_t0)))
            )
                return;
            d.cf.indexA = 1;
            d.cf.typeA = box2d.b2ContactFeatureType.e_vertex;
        ...
        (b = box2d.b2DotVV(h, h)),
            ...
            (l = box2d.b2DotVV(l, l)),
            l > m * m ||
                ((n = box2d.b2CollideEdgeAndCircle.s_n.SetXY(-h.y, h.x)),
                0 > box2d.b2DotVV(n, box2d.b2SubVV(c, f, box2d.b2Vec2.s_t0)) &&
                    n.SetXY(-n.x, -n.y),
                n.Normalize(),
                (d.cf.indexA = 0),
                (d.cf.typeA = box2d.b2ContactFeatureType.e_face),
                (a.pointCount = 1),
...
box2d.b2EPCollider.prototype.Collide = function (a, b, c, e, d) {
    ...
    var f = box2d.b2DotVV(
        ...
        k = !1;
    c &&
        ((g = box2d.b2SubVV(this.m_v1, this.m_v0, box2d.b2EPCollider.s_edge0)),
        g.Normalize(),
        this.m_normal0.SetXY(g.y, -g.x),
        (l = 0 <= box2d.b2CrossVV(g, d)),
        (g = box2d.b2DotVV(
            this.m_normal0,
            box2d.b2SubVV(this.m_centroidB, this.m_v0, box2d.b2Vec2.s_t0)
        )));
    b &&
        ((h = box2d.b2SubVV(this.m_v3, this.m_v2, box2d.b2EPCollider.s_edge2)),
        h.Normalize(),
        this.m_normal2.SetXY(h.y, -h.x),
        (k = 0 < box2d.b2CrossVV(d, h)),
        (h = box2d.b2DotVV(
            this.m_normal2,
    ...
    for (g = e.m_count; f < g; ++f)
        box2d.b2MulXV(this.m_xf, e.m_vertices[f], this.m_polygonB.vertices[f]),
            box2d.b2MulRV(
                this.m_xf.q,
                e.m_normals[f],
                this.m_polygonB.normals[f]
            );
    ...
    if (
        !(
            ...
            ((b = this.ComputePolygonSeparation(
                box2d.b2EPCollider.s_polygonAxis
            )),
            b.type !== box2d.b2EPAxisType.e_unknown &&
                b.separation > this.m_radius)
        )
    ) {
        c =
            b.type === box2d.b2EPAxisType.e_unknown
        ...
        if (c.type === box2d.b2EPAxisType.e_edgeA) {
            ...
            for (g = this.m_polygonB.count; f < g; ++f)
                (k = box2d.b2DotVV(this.m_normal, this.m_polygonB.normals[f])),
                    k < l && ((l = k), (h = f));
            g = h;
        ...
        if (
            ...
            c.type === box2d.b2EPAxisType.e_edgeA
                ...
                : (a.localNormal.Copy(e.m_normals[b.i1]),
                  a.localPoint.Copy(e.m_vertices[b.i1]));
            f = e = 0;
            for (g = box2d.b2_maxManifoldPoints; f < g; ++f)
                box2d.b2DotVV(
                    b.normal,
                    box2d.b2SubVV(h[f].v, b.v1, box2d.b2Vec2.s_t0)
                ) <= this.m_radius &&
                    ((d = a.points[e]),
                    c.type === box2d.b2EPAxisType.e_edgeA
                        ? (box2d.b2MulTXV(this.m_xf, h[f].v, d.localPoint),
                          (d.id = h[f].id))
                        : (d.localPoint.Copy(h[f].v),
                          (d.id.cf.typeA = h[f].id.cf.typeB),
                          (d.id.cf.typeB = h[f].id.cf.typeA),
                          (d.id.cf.indexA = h[f].id.cf.indexB),
                          (d.id.cf.indexB = h[f].id.cf.indexA)),
                    ++e);
            a.pointCount = e;
        }
    }
...
box2d.b2EPCollider.prototype.ComputePolygonSeparation = function (a) {
    ...
    a.separation = -box2d.b2_maxFloat;
    for (
        var b = box2d.b2EPCollider.s_perp.SetXY(
                -this.m_normal.y,
                this.m_normal.x
            ),
            c = 0,
        ...
        var d = box2d.b2NegV(
                this.m_polygonB.normals[c],
                box2d.b2EPCollider.s_n
            ),
            f = box2d.b2DotVV(
                d,
                box2d.b2SubVV(
        ...
        if (0 <= box2d.b2DotVV(d, b)) {
            if (
                box2d.b2DotVV(
                    box2d.b2SubVV(d, this.m_upperLimit, box2d.b2Vec2.s_t0),
                    this.m_normal
            ...
            box2d.b2DotVV(
                box2d.b2SubVV(d, this.m_lowerLimit, box2d.b2Vec2.s_t0),
                this.m_normal
            ) < -box2d.b2_angularSlop
        )
            continue;
...
box2d.b2EdgeShape.prototype.RayCast = function (a, b, c, e) {
    ...
    if (0 === l) return !1;
    l = h / l;
    if (0 > l || b.maxFraction < l) return !1;
...
box2d.b2ChainShape.prototype.CreateLoop = function (a, b) {
    ...
    if (box2d.ENABLE_ASSERTS)
        for (var c = 1; c < b; ++c)
            box2d.b2Assert(
                box2d.b2DistanceSquaredVV(a[c - 1], a[c]) >
...
goog.exportProperty(
    box2d.b2ChainShape,
    "s_edgeShape",
    box2d.b2ChainShape.s_edgeShape
);
...
goog.exportProperty(
    ...
    "Reset",
    box2d.b2ChainAndPolygonContact.prototype.Reset
);
...
box2d.b2ChainAndPolygonContact.prototype.Evaluate.s_edge =
    new box2d.b2EdgeShape();
...
box2d.b2FindMaxSeparation = function (a, b, c, e, d) {
    ...
    for (var l = -box2d.b2_maxFloat, k = 0; k < f; ++k) {
        for (
            var m = box2d.b2MulRV(c.q, h[k], box2d.b2FindMaxSeparation.s_n),
                n = box2d.b2MulXV(c, b[k], box2d.b2FindMaxSeparation.s_v1),
                p = box2d.b2_maxFloat,
                q = 0;
            q < g;
            ++q
...
box2d.b2FindIncidentEdge = function (a, b, c, e, d, f) {
    ...
    c = box2d.b2MulTRV(
        f.q,
        box2d.b2MulRV(c.q, h[e], box2d.b2Vec2.s_t0),
...
box2d.b2CollidePolygons = function (a, b, c, e, d) {
    ...
    if (!(h > f)) {
        ...
        if (!(k > f)) {
            ...
            box2d.b2FindIncidentEdge(g, h, b, m, e, c);
            d = h.m_vertices;
            var l = m,
                h = (m + 1) % h.m_count,
                p = d[l],
            ...
            if (
                !(
                    2 > g ||
                    ((g = box2d.b2ClipSegmentToLine(p, t, k, r, h)), 2 > g)
                )
            ) {
                ...
                for (l = g = 0; l < box2d.b2_maxManifoldPoints; ++l)
                    (d = p[l]),
                        box2d.b2DotVV(m, d.v) - b <= f &&
                            ((h = a.points[g]),
                            box2d.b2MulTXV(c, d.v, h.localPoint),
                            h.id.Copy(d.id),
                            n &&
                                ((d = h.id.cf),
                                (h.id.cf.indexA = d.indexB),
                                (h.id.cf.indexB = d.indexA),
                                (h.id.cf.typeA = d.typeB),
                                (h.id.cf.typeB = d.typeA)),
                            ++g);
                a.pointCount = g;
            }
        }
...
goog.exportProperty(
    ...
    "Reset",
    box2d.b2PolygonContact.prototype.Reset
);
...
box2d.b2CollidePolygonAndCircle = function (a, b, c, e, d) {
    ...
    g < box2d.b2_epsilon
        ? ((a.pointCount = 1),
          ...
          box2d.b2MidVV(m, h, a.localPoint),
          a.points[0].localPoint.Copy(e.m_p),
          (a.points[0].id.key = 0))
        : ((g = box2d.b2DotVV(
              box2d.b2SubVV(c, m, box2d.b2Vec2.s_t0),
              box2d.b2SubVV(h, m, box2d.b2Vec2.s_t1)
          )),
          (f = box2d.b2DotVV(
              box2d.b2SubVV(c, h, box2d.b2Vec2.s_t0),
              box2d.b2SubVV(m, h, box2d.b2Vec2.s_t1)
          )),
          0 >= g
              ? box2d.b2DistanceSquaredVV(c, m) > d * d ||
                ((a.pointCount = 1),
                (a.type = box2d.b2ManifoldType.e_faceA),
                box2d.b2SubVV(c, m, a.localNormal).SelfNormalize(),
                a.localPoint.Copy(m),
                a.points[0].localPoint.Copy(e.m_p),
                (a.points[0].id.key = 0))
              : 0 >= f
              ? box2d.b2DistanceSquaredVV(c, h) > d * d ||
                ((a.pointCount = 1),
                (a.type = box2d.b2ManifoldType.e_faceA),
                box2d.b2SubVV(c, h, a.localNormal).SelfNormalize(),
                a.localPoint.Copy(h),
                a.points[0].localPoint.Copy(e.m_p),
                (a.points[0].id.key = 0))
              : ((f = box2d.b2MidVV(
                ...
                (g = box2d.b2DotVV(
                    box2d.b2SubVV(c, f, box2d.b2Vec2.s_t1),
                    b[k]
                )),
                g > d ||
                    ((a.pointCount = 1),
                    (a.type = box2d.b2ManifoldType.e_faceA),
                    a.localNormal.Copy(b[k]).SelfNormalize(),
                    a.localPoint.Copy(f),
                    a.points[0].localPoint.Copy(e.m_p),
                    (a.points[0].id.key = 0))));
};
...
goog.exportProperty(
    ...
    "Reset",
    box2d.b2CircleContact.prototype.Reset
);
...
goog.exportProperty(
    ...
    "Reset",
    box2d.b2ChainAndCircleContact.prototype.Reset
);
...
box2d.b2ChainAndCircleContact.prototype.Evaluate.s_edge =
    new box2d.b2EdgeShape();
...
goog.exportProperty(
    ...
    "Reset",
    box2d.b2EdgeAndCircleContact.prototype.Reset
);
...
box2d.b2ContactSolver = function () {
    ...
    this.m_positionConstraints =
        box2d.b2ContactPositionConstraint.MakeArray(1024);
    this.m_velocityConstraints =
        box2d.b2ContactVelocityConstraint.MakeArray(1024);
};
...
box2d.b2ContactSolver.prototype.Initialize = function (a) {
    ...
    if (this.m_positionConstraints.length < this.m_count) {
        ...
        for (
            box2d.DEBUG &&
            window.console.log(
                "box2d.b2ContactSolver.m_positionConstraints: " + b
            );
    ...
    for (b = this.m_count; a < b; ++a)
        for (
            d = this.m_contacts[a],
                ...
                g = d.GetManifold(),
                k = g.pointCount,
                box2d.ENABLE_ASSERTS && box2d.b2Assert(0 < k),
                ...
                f.indexB = l.m_islandIndex,
                f.invMassA = h.m_invMass,
                f.invMassB = l.m_invMass,
                f.invIA = h.m_invI,
                f.invIB = l.m_invI,
                f.contactIndex = a,
                f.pointCount = k,
                ...
                d.indexB = l.m_islandIndex,
                d.invMassA = h.m_invMass,
                d.invMassB = l.m_invMass,
                d.localCenterA.Copy(h.m_sweep.localCenter),
                d.localCenterB.Copy(l.m_sweep.localCenter),
                d.invIA = h.m_invI,
                d.invIB = l.m_invI,
            ...
            (h = g.points[c]),
                ...
                this.m_step.warmStarting
                    ? ((k.normalImpulse =
                          this.m_step.dtRatio * h.normalImpulse),
                      (k.tangentImpulse =
                          this.m_step.dtRatio * h.tangentImpulse))
                    : ((k.normalImpulse = 0), (k.tangentImpulse = 0)),
                k.rA.SetZero(),
                k.rB.SetZero(),
                (k.normalMass = 0),
                (k.tangentMass = 0),
                (k.velocityBias = 0),
                d.localPoints[c].Copy(h.localPoint);
    return this;
};
goog.exportProperty(
    box2d.b2ContactSolver.prototype,
...
box2d.b2ContactSolver.prototype.InitializeVelocityConstraints = function () {
    var a,
        ...
        v,
        y,
        D = box2d.b2ContactSolver.prototype.InitializeVelocityConstraints.s_xfA,
    ...
    for (b = this.m_count; a < b; ++a) {
        ...
        box2d.b2SubVV(u, box2d.b2MulRV(x.q, r, box2d.b2Vec2.s_t0), x.p);
        ...
        for (c = 0; c < e; ++c)
            (g = d.points[c]),
                box2d.b2SubVV(w.points[c], f, g.rA),
                box2d.b2SubVV(w.points[c], u, g.rB),
                (q = box2d.b2CrossVV(g.rA, d.normal)),
                (r = box2d.b2CrossVV(g.rB, d.normal)),
                (q = k + m + n * q * q + p * r * r),
                (g.normalMass = 0 < q ? 1 / q : 0),
                (r = d.tangent),
                (q = box2d.b2CrossVV(g.rA, r)),
                (r = box2d.b2CrossVV(g.rB, r)),
                (q = k + m + n * q * q + p * r * r),
                ...
                (q = box2d.b2DotVV(
                    d.normal,
                    box2d.b2SubVV(
                        box2d.b2AddVCrossSV(y, l, g.rB, box2d.b2Vec2.s_t0),
                        box2d.b2AddVCrossSV(s, h, g.rA, box2d.b2Vec2.s_t1),
                        box2d.b2Vec2.s_t0
                    )
                )),
                q < -box2d.b2_velocityThreshold &&
                    (g.velocityBias += -d.restitution * q);
        2 === d.pointCount &&
            ((s = d.points[0]),
            (u = d.points[1]),
            (f = box2d.b2CrossVV(s.rA, d.normal)),
            (s = box2d.b2CrossVV(s.rB, d.normal)),
            (h = box2d.b2CrossVV(u.rA, d.normal)),
            (l = box2d.b2CrossVV(u.rB, d.normal)),
            (u = k + m + n * f * f + p * s * s),
            (y = k + m + n * h * h + p * l * l),
            (k = k + m + n * f * h + p * s * l),
            u * u < 1e3 * (u * y - k * k)
...
box2d.b2ContactSolver.prototype.InitializeVelocityConstraints.s_xfA =
    new box2d.b2Transform();
box2d.b2ContactSolver.prototype.InitializeVelocityConstraints.s_xfB =
    new box2d.b2Transform();
box2d.b2ContactSolver.prototype.InitializeVelocityConstraints.s_worldManifold =
...
box2d.b2ContactSolver.prototype.WarmStart = function () {
    var a,
        ...
        s,
        u,
        v = box2d.b2ContactSolver.prototype.WarmStart.s_P;
    a = 0;
    for (b = this.m_count; a < b; ++a) {
        d = this.m_velocityConstraints[a];
        f = d.indexA;
        ...
        for (c = 0; c < e; ++c)
            (u = d.points[c]),
                box2d.b2AddVV(
                    box2d.b2MulSV(u.normalImpulse, t, box2d.b2Vec2.s_t0),
                    box2d.b2MulSV(u.tangentImpulse, s, box2d.b2Vec2.s_t1),
                    v
                ),
                (p -= l * box2d.b2CrossVV(u.rA, v)),
                n.SelfMulSub(h, v),
                (r += m * box2d.b2CrossVV(u.rB, v)),
                q.SelfMulAdd(k, v);
...
box2d.b2ContactSolver.prototype.SolveVelocityConstraints = function () {
    var a,
        ...
        w,
        C,
        A = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P,
    ...
    for (b = this.m_count; a < b; ++a) {
        ...
        for (e = n; c < e; ++c)
            (n = d.points[c]),
                box2d.b2SubVV(
                    box2d.b2AddVCrossSV(r, t, n.rB, box2d.b2Vec2.s_t0),
                    box2d.b2AddVCrossSV(p, q, n.rA, box2d.b2Vec2.s_t1),
                    y
                ),
                (w = box2d.b2DotVV(y, u) - d.tangentSpeed),
                (w = n.tangentMass * -w),
                (C = v * n.normalImpulse),
                (C = box2d.b2Clamp(n.tangentImpulse + w, -C, C)),
                (w = C - n.tangentImpulse),
                (n.tangentImpulse = C),
                box2d.b2MulSV(w, u, A),
                p.SelfMulSub(h, A),
                (q -= l * box2d.b2CrossVV(n.rA, A)),
                r.SelfMulAdd(k, A),
                (t += m * box2d.b2CrossVV(n.rB, A));
        if (1 === d.pointCount)
            (n = d.points[0]),
                box2d.b2SubVV(
                    box2d.b2AddVCrossSV(r, t, n.rB, box2d.b2Vec2.s_t0),
                ...
                (d = box2d.b2DotVV(y, s)),
                (w = -n.normalMass * (d - n.velocityBias)),
                (C = box2d.b2Max(n.normalImpulse + w, 0)),
                (w = C - n.normalImpulse),
                (n.normalImpulse = C),
                box2d.b2MulSV(w, s, A),
                p.SelfMulSub(h, A),
            ...
            for (
                c = d.points[0],
                    u = d.points[1],
                    E.SetXY(c.normalImpulse, u.normalImpulse),
                    box2d.ENABLE_ASSERTS &&
                        box2d.b2Assert(0 <= E.x && 0 <= E.y),
                    box2d.b2SubVV(
                        box2d.b2AddVCrossSV(r, t, c.rB, box2d.b2Vec2.s_t0),
                        box2d.b2AddVCrossSV(p, q, c.rA, box2d.b2Vec2.s_t1),
                        D
                    ),
                    box2d.b2SubVV(
                        box2d.b2AddVCrossSV(r, t, u.rB, box2d.b2Vec2.s_t0),
                        box2d.b2AddVCrossSV(p, q, u.rA, box2d.b2Vec2.s_t1),
                        x
                    ),
                    v = box2d.b2DotVV(D, s),
                    n = box2d.b2DotVV(x, s),
                    B.x = v - c.velocityBias,
                    B.y = n - u.velocityBias,
                    B.SelfSub(box2d.b2MulMV(d.K, E, box2d.b2Vec2.s_t0));
                ;
                ...
                if (0 <= z.x && 0 <= z.y) {
                    ...
                    q -=
                        l *
                        (box2d.b2CrossVV(c.rA, F) + box2d.b2CrossVV(u.rA, H));
                    r.SelfMulAdd(k, I);
                    t +=
                        m *
                        (box2d.b2CrossVV(c.rB, F) + box2d.b2CrossVV(u.rB, H));
                    c.normalImpulse = z.x;
                    u.normalImpulse = z.y;
                    break;
                }
...
box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_dv =
    new box2d.b2Vec2();
box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_dv1 =
    new box2d.b2Vec2();
box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_dv2 =
    new box2d.b2Vec2();
box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P =
    new box2d.b2Vec2();
box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_a =
    new box2d.b2Vec2();
box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_b =
    new box2d.b2Vec2();
box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_x =
    new box2d.b2Vec2();
box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_d =
    new box2d.b2Vec2();
box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P1 =
    new box2d.b2Vec2();
box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P2 =
    new box2d.b2Vec2();
box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P1P2 =
    new box2d.b2Vec2();
box2d.b2ContactSolver.prototype.StoreImpulses = function () {
    ...
    for (b = this.m_count; a < b; ++a)
        for (
            ...
            (f.points[c].normalImpulse = d.points[c].normalImpulse),
                (f.points[c].tangentImpulse = d.points[c].tangentImpulse);
};
goog.exportProperty(
    box2d.b2ContactSolver.prototype,
    "StoreImpulses",
...
box2d.b2PositionSolverManifold.prototype.Initialize = function (a, b, c, e) {
    ...
    switch (a.type) {
        case box2d.b2ManifoldType.e_circles:
            ...
            this.separation =
                box2d.b2DotVV(
                    box2d.b2SubVV(f, d, box2d.b2Vec2.s_t0),
                    this.normal
                ) -
                a.radiusA -
                a.radiusB;
        ...
        case box2d.b2ManifoldType.e_faceA:
            ...
            this.separation =
                box2d.b2DotVV(
                    box2d.b2SubVV(h, g, box2d.b2Vec2.s_t0),
                    this.normal
                ) -
                a.radiusA -
                a.radiusB;
        ...
        case box2d.b2ManifoldType.e_faceB:
            box2d.b2MulRV(c.q, a.localNormal, this.normal),
                ...
                box2d.b2MulXV(b, a.localPoints[e], h),
                (this.separation =
                    box2d.b2DotVV(
                        box2d.b2SubVV(h, g, box2d.b2Vec2.s_t0),
                        this.normal
...
box2d.b2PositionSolverManifold.prototype.Initialize.s_pointA =
    new box2d.b2Vec2();
box2d.b2PositionSolverManifold.prototype.Initialize.s_pointB =
    new box2d.b2Vec2();
box2d.b2PositionSolverManifold.prototype.Initialize.s_planePoint =
    new box2d.b2Vec2();
box2d.b2PositionSolverManifold.prototype.Initialize.s_clipPoint =
    new box2d.b2Vec2();
box2d.b2ContactSolver.prototype.SolvePositionConstraints = function () {
    var a,
        ...
        t,
        s,
        u = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_xfA,
        ...
        x,
        w,
        C = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_rA,
    ...
    for (b = this.m_count; a < b; ++a) {
        ...
        for (c = 0; c < e; ++c)
            u.q.SetAngleRadians(r),
                v.q.SetAngleRadians(s),
                box2d.b2SubVV(q, box2d.b2MulRV(u.q, h, box2d.b2Vec2.s_t0), u.p),
                box2d.b2SubVV(t, box2d.b2MulRV(v.q, m, box2d.b2Vec2.s_t0), v.p),
                y.Initialize(d, u, v, c),
                (D = y.normal),
                (x = y.point),
                (w = y.separation),
                box2d.b2SubVV(x, q, C),
                ...
                (z = box2d.b2Min(z, w)),
                (x = box2d.b2Clamp(
                    box2d.b2_baumgarte * (w + box2d.b2_linearSlop),
                    -box2d.b2_maxLinearCorrection,
                    0
                )),
                (w = box2d.b2CrossVV(C, D)),
                (E = box2d.b2CrossVV(A, D)),
                (w = l + n + k * w * w + p * E * E),
                (x = 0 < w ? -x / w : 0),
                box2d.b2MulSV(x, D, B),
                q.SelfMulSub(l, B),
                (r -= k * box2d.b2CrossVV(C, B)),
                t.SelfMulAdd(n, B),
                (s += p * box2d.b2CrossVV(A, B));
...
box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_xfA =
    new box2d.b2Transform();
box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_xfB =
    new box2d.b2Transform();
box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_psm =
    new box2d.b2PositionSolverManifold();
box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_rA =
    new box2d.b2Vec2();
box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_rB =
    new box2d.b2Vec2();
box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_P =
    new box2d.b2Vec2();
box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints = function (a, b) {
    var c,
        ...
        u,
        v,
        y = box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints.s_xfA,
        ...
        C,
        A,
        E = box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints.s_rA,
        B = box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints.s_rB,
        z,
        G = box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints.s_P,
        F = 0;
    c = 0;
    for (e = this.m_count; c < e; ++c) {
        ...
        v = this.m_positions[l].a;
        for (d = 0; d < f; ++d)
            y.q.SetAngleRadians(s),
                D.q.SetAngleRadians(v),
                box2d.b2SubVV(t, box2d.b2MulRV(y.q, k, box2d.b2Vec2.s_t0), y.p),
                box2d.b2SubVV(u, box2d.b2MulRV(D.q, m, box2d.b2Vec2.s_t0), D.p),
                x.Initialize(g, y, D, d),
                (w = x.normal),
                (C = x.point),
                (A = x.separation),
                box2d.b2SubVV(C, t, E),
                ...
                (F = box2d.b2Min(F, A)),
                (C = box2d.b2Clamp(
                    box2d.b2_toiBaumgarte * (A + box2d.b2_linearSlop),
                    -box2d.b2_maxLinearCorrection,
                    0
                )),
                (A = box2d.b2CrossVV(E, w)),
                (z = box2d.b2CrossVV(B, w)),
                (A = n + q + p * A * A + r * z * z),
                (C = 0 < A ? -C / A : 0),
                box2d.b2MulSV(C, w, G),
                t.SelfMulSub(n, G),
                (s -= p * box2d.b2CrossVV(E, G)),
                u.SelfMulAdd(q, G),
                (v += r * box2d.b2CrossVV(B, G));
...
box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints.s_xfA =
    new box2d.b2Transform();
box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints.s_xfB =
    new box2d.b2Transform();
box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints.s_psm =
    new box2d.b2PositionSolverManifold();
box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints.s_rA =
    new box2d.b2Vec2();
box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints.s_rB =
    new box2d.b2Vec2();
box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints.s_P =
    new box2d.b2Vec2();
...
box2d.b2ContactFilter.prototype.ShouldCollide = function (a, b) {
    var c = a.GetFilterData(),
        e = b.GetFilterData();
    return c.groupIndex === e.groupIndex && 0 !== c.groupIndex
        ? 0 < c.groupIndex
        : 0 !== (c.maskBits & e.categoryBits) &&
              0 !== (c.categoryBits & e.maskBits);
};
goog.exportProperty(
    ...
    if (this.m_positions.length < a)
        for (
            b = box2d.b2Max(2 * this.m_positions.length, a),
                box2d.DEBUG &&
                    window.console.log("box2d.b2Island.m_positions: " + b);
    ...
    if (this.m_velocities.length < a)
        for (
            b = box2d.b2Max(2 * this.m_velocities.length, a),
                box2d.DEBUG &&
                    window.console.log("box2d.b2Island.m_velocities: " + b);
            this.m_velocities.length < b;

        )
            this.m_velocities[this.m_velocities.length] =
                new box2d.b2Velocity();
};
goog.exportProperty(
    box2d.b2Island.prototype,
    "Initialize",
...
box2d.b2Island.prototype.Solve = function (a, b, c, e) {
    for (
        var d = box2d.b2Island.s_timer.Reset(), f = b.dt, g = 0;
        g < this.m_bodyCount;
        ++g
    ) {
    ...
    for (g = 0; g < this.m_bodyCount; ++g) {
        ...
        box2d.b2DotVV(p, p) > box2d.b2_maxTranslationSquared &&
            ((p = box2d.b2_maxTranslation / p.GetLength()), m.SelfMul(p));
        p = f * n;
        ...
        for (g = 0; g < this.m_bodyCount; ++g)
            (h = this.m_bodies[g]),
                h.GetType() !== box2d.b2BodyType.b2_staticBody &&
                    ...
                    h.m_angularVelocity * h.m_angularVelocity > d ||
                    box2d.b2DotVV(h.m_linearVelocity, h.m_linearVelocity) > e
                        ? (a = h.m_sleepTime = 0)
                        : ((h.m_sleepTime += f),
...
box2d.b2Island.prototype.SolveTOI = function (a, b, c) {
    ...
    for (
        e = 0;
        e < a.positionIterations && !d.SolveTOIPositionConstraints(b, c);
        ++e
    );
    ...
    for (e = 0; e < this.m_bodyCount; ++e) {
        ...
        box2d.b2DotVV(h, h) > box2d.b2_maxTranslationSquared &&
            ((h = box2d.b2_maxTranslation / h.GetLength()), f.SelfMul(h));
        h = a * g;
        ...
        for (var b = 0; b < this.m_contactCount; ++b) {
            ...
            if (c) {
                ...
                for (var f = 0; f < e.pointCount; ++f)
                    (d.normalImpulses[f] = e.points[f].normalImpulse),
                        (d.tangentImpulses[f] = e.points[f].tangentImpulse);
...
box2d.b2ContactFactory.prototype.AddType = function (a, b, c, e) {
    ...
    c !== e &&
        ((this.m_registers[e][c].pool = d),
        (this.m_registers[e][c].createFcn = b),
        (this.m_registers[e][c].destroyFcn = f),
...
box2d.b2ContactFactory.prototype.Create = function (a, b, c, e) {
    var d = a.GetType(),
        f = c.GetType();
    box2d.ENABLE_ASSERTS &&
        box2d.b2Assert(0 <= d && d < box2d.b2ShapeType.e_shapeTypeCount);
    box2d.ENABLE_ASSERTS &&
    ...
    return null !== f
        ? (d.primary
              ? ((d = f(this.m_allocator)), d.Reset(a, b, c, e))
              : ((d = f(this.m_allocator)), d.Reset(c, e, a, b)),
          d)
        : null;
};
goog.exportProperty(
                ...
                if (
                    !(
                        ...
                        box2d.b2Abs(
                            box2d.b2DotVV(
                                d,
                                box2d.b2SubVV(c, k, box2d.b2Vec2.s_t0)
                            )
                        ) -
                            box2d.b2DotVV(f, n)
                    )
...
box2d.b2DynamicTree.prototype.MoveProxy = function (a, b, c) {
    ...
    var e =
        ...
        box2d.b2_aabbMultiplier * (0 < c.x ? c.x : -c.x);
    c =
        box2d.b2_aabbExtension +
        box2d.b2_aabbMultiplier * (0 < c.y ? c.y : -c.y);
    ...
    if (null === this.m_root) (this.m_root = a), (this.m_root.parent = null);
        ...
        for (var c = this.m_root, e, d; !1 === c.IsLeaf(); ) {
            ...
            var h = g.GetPerimeter(),
                ...
                m;
            e.IsLeaf()
                ? (l.Combine2(b, e.aabb), (f = l.GetPerimeter() + h))
                : (l.Combine2(b, e.aabb),
                  (k = e.aabb.GetPerimeter()),
                  (m = l.GetPerimeter()),
                  (f = m - k + h));
            d.IsLeaf()
                ? (l.Combine2(b, d.aabb), (h = l.GetPerimeter() + h))
                : (l.Combine2(b, d.aabb),
                  (k = d.aabb.GetPerimeter()),
                  (m = l.GetPerimeter()),
                  (h = m - k + h));
            if (g < f && g < h) break;
            c = f < h ? e : d;
        ...
        d.height = c.height + 1;
        e
            ? (e.child1 === c ? (e.child1 = d) : (e.child2 = d),
              (d.child1 = c),
              (d.child2 = a),
              (c.parent = d),
              (a.parent = d))
        ...
        for (c = a.parent; null !== c; )
            (c = this.Balance(c)),
                ...
                (c.height = 1 + box2d.b2Max(e.height, d.height)),
                c.aabb.Combine2(e.aabb, d.aabb),
                (c = c.parent);
    }
};
goog.exportProperty(
...
box2d.b2DynamicTree.prototype.ValidateMetrics = function (a) {
    if (null !== a) {
        ...
        if (a.IsLeaf())
            ...
            box2d.ENABLE_ASSERTS &&
                box2d.b2Assert(e.lowerBound === a.aabb.lowerBound);
            box2d.ENABLE_ASSERTS &&
...
box2d.b2BroadPhase.prototype.UpdatePairs = function (a) {
        ...
        if (null !== c) {
            ...
            this.m_tree.Query(function (a) {
                ...
                e.m_pairCount === e.m_pairBuffer.length &&
                    (e.m_pairBuffer[e.m_pairCount] = new box2d.b2Pair());
    ...
    for (b = 0; b < this.m_pairCount; ) {
        ...
        for (++b; b < this.m_pairCount; ) {
            ...
            if (
                f.proxyA.m_id !== d.proxyA.m_id ||
                f.proxyB.m_id !== d.proxyB.m_id
            )
                break;
            ++b;
        }
    ...
    for (var a = this.m_contactList; a; ) {
        ...
        if (a.m_flags & box2d.b2ContactFlag.e_filterFlag) {
            ...
            if (
                ...
                !1 === this.m_contactFilter.ShouldCollide(b, c)
            ) {
                b = a;
                a = b.m_next;
                this.Destroy(b);
...
box2d.b2ContactManager.prototype.AddPair = function (a, b) {
    ...
    if (g !== h) {
        ...
        !1 === h.ShouldCollide(g) ||
            (this.m_contactFilter &&
                !1 === this.m_contactFilter.ShouldCollide(c, e)) ||
            ((d = this.m_contactFactory.Create(c, d, e, f)),
            null !== d &&
                ((c = d.GetFixtureA()),
                (e = d.GetFixtureB()),
                d.GetChildIndexA(),
                ...
                (d.m_nodeA.other = h),
                (d.m_nodeA.prev = null),
                (d.m_nodeA.next = g.m_contactList),
                null !== g.m_contactList && (g.m_contactList.prev = d.m_nodeA),
                (g.m_contactList = d.m_nodeA),
                (d.m_nodeB.contact = d),
                (d.m_nodeB.other = g),
                (d.m_nodeB.prev = null),
                (d.m_nodeB.next = h.m_contactList),
                null !== h.m_contactList && (h.m_contactList.prev = d.m_nodeB),
                (h.m_contactList = d.m_nodeB),
                !1 === c.IsSensor() &&
                    !1 === e.IsSensor() &&
                    (g.SetAwake(!0), h.SetAwake(!0)),
                ++this.m_contactCount));
    }
};
goog.exportSymbol(
...
box2d.b2JointFactory.Create = function (a, b) {
    ...
    switch (a.type) {
        ...
        case box2d.b2JointType.e_gearJoint:
            c = new box2d.b2GearJoint(
                a instanceof box2d.b2GearJointDef ? a : null
            );
            break;
        case box2d.b2JointType.e_wheelJoint:
            c = new box2d.b2WheelJoint(
                a instanceof box2d.b2WheelJointDef ? a : null
            );
            break;
        case box2d.b2JointType.e_weldJoint:
            c = new box2d.b2WeldJoint(
                a instanceof box2d.b2WeldJointDef ? a : null
            );
            break;
        ...
        case box2d.b2JointType.e_ropeJoint:
            c = new box2d.b2RopeJoint(
                a instanceof box2d.b2RopeJointDef ? a : null
            );
            break;
        case box2d.b2JointType.e_motorJoint:
            c = new box2d.b2MotorJoint(
                a instanceof box2d.b2MotorJointDef ? a : null
            );
            break;
        case box2d.b2JointType.e_areaJoint:
            c = new box2d.b2AreaJoint(
                a instanceof box2d.b2AreaJointDef ? a : null
            );
            break;
        default:
            box2d.ENABLE_ASSERTS && box2d.b2Assert(!1);
...
box2d.b2Body = function (a, b) {
    ...
    box2d.ENABLE_ASSERTS &&
        box2d.b2Assert(
            box2d.b2IsValid(a.angularDamping) && 0 <= a.angularDamping
        );
    box2d.ENABLE_ASSERTS &&
        box2d.b2Assert(
            box2d.b2IsValid(a.linearDamping) && 0 <= a.linearDamping
        );
...
goog.exportProperty(
    ...
    "m_flags",
    box2d.b2Body.prototype.m_flags
);
...
goog.exportProperty(
    box2d.b2Body.prototype,
    "CreateFixture2",
    box2d.b2Body.prototype.CreateFixture2
);
...
goog.exportProperty(
    box2d.b2Body.prototype,
    "SetTransformXYRadians",
    box2d.b2Body.prototype.SetTransformXYRadians
);
...
box2d.b2Body.prototype.SetLinearVelocity = function (a) {
    this.m_type !== box2d.b2BodyType.b2_staticBody &&
        (0 < box2d.b2DotVV(a, a) && this.SetAwake(!0),
...
box2d.b2Body.prototype.ResetMassData = function () {
    ...
    if (
        ...
        for (
            var a =
                    box2d.b2Body.prototype.ResetMassData.s_localCenter.SetZero(),
                b = this.m_fixtureList;
            b;
            b = b.m_next
        )
            if (0 !== b.m_density) {
                var c = b.GetMassData(
                    box2d.b2Body.prototype.ResetMassData.s_massData
                );
                this.m_mass += c.mass;
        ...
        0 === (this.m_flags & box2d.b2BodyFlag.e_fixedRotationFlag)
            ? ((this.m_I -= this.m_mass * box2d.b2DotVV(a, a)),
              ...
              (this.m_invI = 1 / this.m_I))
            : (this.m_invI = this.m_I = 0);
        b = box2d.b2Body.prototype.ResetMassData.s_oldCenter.Copy(
            this.m_sweep.c
        );
...
goog.exportProperty(
    ...
    "m_flags",
    box2d.b2World.prototype.m_flags
);
...
box2d.b2World.prototype.SetAllowSleeping = function (a) {
    if (
        a !== this.m_allowSleep &&
        ((this.m_allowSleep = a), !1 === this.m_allowSleep)
    )
...
box2d.b2World.prototype.Solve = function (a) {
    ...
    for (
        var e = this.m_bodyCount, d = this.s_stack, f = this.m_bodyList;
        f;
        f = f.m_next
    )
        if (
            ...
            for (f.m_flags |= box2d.b2BodyFlag.e_islandFlag; 0 < g; )
                if (
                    ((c = d[--g]),
                    box2d.ENABLE_ASSERTS && box2d.b2Assert(!0 === c.IsActive()),
                    b.AddBody(c),
                    c.SetAwake(!0),
                    c.GetType() !== box2d.b2BodyType.b2_staticBody)
                ) {
                    for (var h = c.m_contactList; h; h = h.next) {
                        var l = h.contact;
                        if (
    ...
    for (c = this.m_bodyList; c; c = c.m_next)
        0 !== (c.m_flags & box2d.b2BodyFlag.e_islandFlag) &&
            c.GetType() !== box2d.b2BodyType.b2_staticBody &&
...
box2d.b2World.prototype.SolveTOI = function (a) {
    ...
    for (;;) {
        for (
            var d = null, c = 1, e = this.m_contactManager.m_contactList;
            e;
            e = e.m_next
        )
            if (
                ...
                if (e.m_flags & box2d.b2ContactFlag.e_toiFlag) f = e.m_toi;
                    ...
                    box2d.ENABLE_ASSERTS &&
                        box2d.b2Assert(
                            k === box2d.b2BodyType.b2_dynamicBody ||
                    ...
                    if (!1 === k && !1 === m) continue;
                    m = f.m_sweep.alpha0;
                    f.m_sweep.alpha0 < l.m_sweep.alpha0
                        ? ((m = l.m_sweep.alpha0), f.m_sweep.Advance(m))
                        : l.m_sweep.alpha0 < f.m_sweep.alpha0 &&
                          ((m = f.m_sweep.alpha0), l.m_sweep.Advance(m));
        ...
        if (!1 === d.IsEnabled() || !1 === d.IsTouching())
            ...
            for (d = 0; 2 > d; ++d)
                if (
                    ((e = 0 === d ? f : l),
                    e.m_type === box2d.b2BodyType.b2_dynamicBody)
                )
                    for (
                        g = e.m_contactList;
                        g &&
                        ...
                        (h = g.contact),
                            h.m_flags & box2d.b2ContactFlag.e_islandFlag ||
                                ((m = g.other),
                                m.m_type === box2d.b2BodyType.b2_dynamicBody &&
                                    !1 === e.IsBullet() &&
                                    !1 === m.IsBullet()) ||
                                ((k = h.m_fixtureB.m_isSensor),
                                h.m_fixtureA.m_isSensor ||
                                    k ||
                                    ((k =
                                        box2d.b2World.prototype.SolveTOI.s_backup.Copy(
                                            m.m_sweep
                                        )),
                                    0 ===
                                        (m.m_flags &
            ...
            for (d = 0; d < b.m_bodyCount; ++d)
                if (
                    ...
                    for (
                        e.SynchronizeFixtures(), g = e.m_contactList;
                        g;
                        g = g.next
                    )
                        g.contact.m_flags &= ~(
...
box2d.b2World.prototype.QueryAABB = function (a, b) {
    ...
    c.Query(function (b) {
        b = c.GetUserData(b);
        box2d.ENABLE_ASSERTS &&
            box2d.b2Assert(b instanceof box2d.b2FixtureProxy);
        b = b.fixture;
...
box2d.b2World.prototype.RayCast = function (a, b, c) {
    ...
    e.RayCast(function (d, g) {
        ...
        box2d.ENABLE_ASSERTS &&
            box2d.b2Assert(h instanceof box2d.b2FixtureProxy);
        var l = h.fixture,
        ...
        if (l.RayCast(k, d, h.childIndex)) {
            ...
            return a instanceof box2d.b2RayCastCallback
                ? a.ReportFixture(l, m, k.normal, h)
                : a(l, m, k.normal, h);
        }
    ...
    switch (c.m_type) {
        ...
        case box2d.b2ShapeType.e_chainShape:
            ...
            for (var g = 1; g < e; ++g)
                (d = f[g]),
                    this.m_debugDraw.DrawSegment(c, d, b),
                    this.m_debugDraw.DrawCircle(d, 0.05, b),
                    (c = d);
            break;
        case box2d.b2ShapeType.e_polygonShape:
            (e = c instanceof box2d.b2PolygonShape ? c : null),
                (c = e.m_count),
                (f = e.m_vertices),
...
box2d.b2World.prototype.DrawJoint = function (a) {
    ...
    switch (a.m_type) {
        ...
        case box2d.b2JointType.e_mouseJoint:
            ...
            break;
        default:
            this.m_debugDraw.DrawSegment(e, c, f),
                this.m_debugDraw.DrawSegment(c, b, f),
...
box2d.b2World.prototype.DrawDebugData = function () {
    if (null !== this.m_debugDraw) {
        ...
        if (a & box2d.b2DrawFlags.e_centerOfMassBit)
            for (c = this.m_bodyList; c; c = c.m_next)
                (e = box2d.b2World.prototype.DrawDebugData.s_xf),
                    e.q.Copy(c.m_xf.q),
                    e.p.Copy(c.GetWorldCenter()),
...
box2d.b2AreaJoint = function (a) {
    ...
    for (
        var c = (this.m_targetArea = 0), e = this.m_bodies.length;
        c < e;
        ++c
    ) {
...
box2d.b2AreaJoint.prototype.SolvePositionConstraints = function (a) {
    ...
    for (d = this.m_bodies.length; e < d; ++e)
        (f = this.m_bodies[e]),
            ...
            (h = box2d.b2AddVV(
                this.m_normals[e],
                this.m_normals[(e + 1) % d],
                this.m_delta
            )),
            h.SelfMul(b),
            (g = h.GetLengthSquared()),
    ...
    if (this.m_bodyList)
        for (
            ...
            if (!1 !== b.IsAwake()) {
                ...
                e.y /= f;
                d < box2d.b2_epsilon ||
                    ((f = box2d.b2NegV(this.gravity, new box2d.b2Vec2())),
                    f.SelfMul(this.density * d),
                    b.ApplyForce(f, e),
                    (e = b.GetLinearVelocityFromWorldPoint(
                        c,
                        new box2d.b2Vec2()
                    )),
                    e.SelfSub(this.velocity),
                    e.SelfMul(-this.linearDrag * d),
                    b.ApplyForce(e, c),
                    b.ApplyTorque(
        ...
        for (var b = this.m_bodyList; b; b = b.nextBody) {
            ...
            if (c.IsAwake()) {
                ...
                c.SetLinearVelocity(
                    box2d.b2AddVV(
                        c.GetLinearVelocity(),
                        box2d.b2MulSV(a, e, box2d.b2Vec2.s_t0),
                        box2d.b2Vec2.s_t1
                    )
                );
            }
...
box2d.b2DistanceJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    this.m_u.y = d.y + this.m_rB.y - b.y - this.m_rA.y;
    ...
    if (0 < this.m_frequencyHz) {
        ...
        this.m_gamma = 0 !== this.m_gamma ? 1 / this.m_gamma : 0;
        this.m_bias = d * k * f * this.m_gamma;
        b += this.m_gamma;
        this.m_mass = 0 !== b ? 1 / b : 0;
...
box2d.b2FrictionJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    a.step.warmStarting
        ? (this.m_linearImpulse.SelfMul(a.step.dtRatio),
          ...
          b.SelfMulSub(e, g),
          (c -= k * (box2d.b2CrossVV(this.m_rA, g) + this.m_angularImpulse)),
          d.SelfMulAdd(l, g),
          (f += m * (box2d.b2CrossVV(this.m_rB, g) + this.m_angularImpulse)))
...
box2d.b2FrictionJoint.prototype.SolveVelocityConstraints = function (a) {
    ...
    n = box2d
        ...
        .SelfNeg();
    p =
        box2d.b2FrictionJoint.prototype.SolveVelocityConstraints.s_oldImpulseV.Copy(
            this.m_linearImpulse
        );
    this.m_linearImpulse.SelfAdd(n);
    m = k * this.m_maxForce;
    this.m_linearImpulse.GetLengthSquared() > m * m &&
...
box2d.b2FrictionJoint.prototype.SolveVelocityConstraints.s_impulseV =
    new box2d.b2Vec2();
box2d.b2FrictionJoint.prototype.SolveVelocityConstraints.s_oldImpulseV =
    new box2d.b2Vec2();
...
box2d.b2MouseJoint.prototype.SolveVelocityConstraints = function (a) {
    var b = a.velocities[this.m_indexB].v,
        ...
        d =
            box2d.b2MouseJoint.prototype.SolveVelocityConstraints.s_oldImpulse.Copy(
                this.m_impulse
            );
    this.m_impulse.SelfAdd(e);
    var f = a.step.dt * this.m_maxForce;
    this.m_impulse.GetLengthSquared() > f * f &&
        this.m_impulse.SelfMul(f / this.m_impulse.GetLength());
...
box2d.b2MouseJoint.prototype.SolveVelocityConstraints.s_impulse =
    new box2d.b2Vec2();
box2d.b2MouseJoint.prototype.SolveVelocityConstraints.s_oldImpulse =
    new box2d.b2Vec2();
...
box2d.b2MouseJoint.prototype.GetAnchorA = function (a) {
    if ("undefined" == typeof a) a = new box2d.b2Vec2();
    return a.Copy(this.m_targetA);
};
goog.exportProperty(
    box2d.b2MouseJoint.prototype,
...
box2d.b2PulleyJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    b > 10 * box2d.b2_linearSlop
        ? this.m_uA.SelfMul(1 / b)
        : this.m_uA.SetZero();
    d > 10 * box2d.b2_linearSlop
        ? this.m_uB.SelfMul(1 / d)
        : this.m_uB.SetZero();
    ...
    this.m_mass =
        this.m_invMassA +
        this.m_invIA * b * b +
        this.m_ratio * this.m_ratio * (this.m_invMassB + this.m_invIB * d * d);
    ...
    a.step.warmStarting
        ? ((this.m_impulse *= a.step.dtRatio),
          ...
          (e += this.m_invIA * box2d.b2CrossVV(this.m_rA, b)),
          g.SelfMulAdd(this.m_invMassB, d),
          (h += this.m_invIB * box2d.b2CrossVV(this.m_rB, d)))
        : (this.m_impulse = 0);
    a.velocities[this.m_indexA].w = e;
    a.velocities[this.m_indexB].w = h;
};
...
box2d.b2PulleyJoint.prototype.SolvePositionConstraints = function (a) {
    ...
    var n = box2d.b2CrossVV(f, h),
        ...
        n =
            ...
            this.m_ratio *
                this.m_ratio *
                (this.m_invMassB + this.m_invIB * p * p);
    0 < n && (n = 1 / n);
...
box2d.b2CircleShape.prototype.RayCast = function (a, b, c, e) {
    ...
    return 0 <= f && f <= b.maxFraction * g
        ? ((f /= g),
          (a.fraction = f),
          box2d.b2AddVMulSV(c, f, e, a.normal).SelfNormalize(),
          !0)
        : !1;
};
goog.exportProperty(
...
box2d.b2CircleShape.prototype.ComputeSubmergedArea = function (a, b, c, e) {
    ...
    var f = d * d,
        d =
            b * (box2d.b2Asin(d / this.m_radius) + box2d.b2_pi / 2) +
            d * box2d.b2Sqrt(b - f);
...
box2d.b2Rope.prototype.Initialize = function (a) {
    ...
    for (b = 0; b < c; ++b)
        (d = this.m_ps[b]),
            (f = this.m_ps[b + 1]),
            (e = this.m_ps[b + 2]),
            (d = box2d.b2SubVV(f, d, box2d.b2Vec2.s_t0)),
            (e = box2d.b2SubVV(e, f, box2d.b2Vec2.s_t1)),
            (f = box2d.b2CrossVV(d, e)),
            (d = box2d.b2DotVV(d, e)),
            (this.m_as[b] = box2d.b2Atan2(f, d));
...
box2d.b2Rope.prototype.Step = function (a, b) {
    if (0 !== a) {
        for (
            var c = Math.exp(-a * this.m_damping), e = 0;
            e < this.m_count;
            ++e
        )
            this.m_p0s[e].Copy(this.m_ps[e]),
                0 < this.m_ims[e] && this.m_vs[e].SelfMulAdd(a, this.m_gravity),
                this.m_vs[e].SelfMul(c),
                this.m_ps[e].SelfMulAdd(a, this.m_vs[e]);
        for (e = 0; e < b; ++e) this.SolveC2(), this.SolveC3(), this.SolveC2();
        c = 1 / a;
        for (e = 0; e < this.m_count; ++e)
            box2d.b2MulSV(
                c,
                box2d.b2SubVV(this.m_ps[e], this.m_p0s[e], box2d.b2Vec2.s_t0),
                this.m_vs[e]
            );
    }
};
...
goog.exportProperty(
    box2d.b2Rope.prototype,
    "SetAngleRadians",
    box2d.b2Rope.prototype.SetAngleRadians
);
    ...
    for (var a = this.m_count - 2, b = 0; b < a; ++b) {
        ...
        if (0 !== m * n) {
            var p = box2d.b2CrossVV(l, k),
                ...
                k = box2d.b2NegV(l, box2d.b2Rope.s_J1),
...
box2d.b2WheelJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    f = box2d.b2SubVV(
        box2d.b2AddVV(l, q, box2d.b2Vec2.s_t0),
        box2d.b2AddVV(f, k, box2d.b2Vec2.s_t1),
    ...
    this.m_sAy = box2d.b2CrossVV(
        box2d.b2AddVV(f, k, box2d.b2Vec2.s_t0),
        this.m_ay
    );
    this.m_sBy = box2d.b2CrossVV(q, this.m_ay);
    this.m_mass =
        b + c + e * this.m_sAy * this.m_sAy + d * this.m_sBy * this.m_sBy;
    0 < this.m_mass && (this.m_mass = 1 / this.m_mass);
    this.m_gamma = this.m_bias = this.m_springMass = 0;
    0 < this.m_frequencyHz
        ? (box2d.b2MulRV(p, this.m_localXAxisA, this.m_ax),
          ...
          (b =
              b +
              c +
              e * this.m_sAx * this.m_sAx +
              d * this.m_sBx * this.m_sBx),
          0 < b &&
              ((this.m_springMass = 1 / b),
              (c = box2d.b2DotVV(f, this.m_ax)),
              (p = 2 * box2d.b2_pi * this.m_frequencyHz),
              (f = this.m_springMass * p * p),
              (l = a.step.dt),
              (this.m_gamma =
                  l *
                  (2 * this.m_springMass * this.m_dampingRatio * p + l * f)),
              0 < this.m_gamma && (this.m_gamma = 1 / this.m_gamma),
              (this.m_bias = c * l * f * this.m_gamma),
              (this.m_springMass = b + this.m_gamma),
              0 < this.m_springMass &&
                  (this.m_springMass = 1 / this.m_springMass)))
        : (this.m_springImpulse = 0);
    this.m_enableMotor
        ? ((this.m_motorMass = e + d),
          0 < this.m_motorMass && (this.m_motorMass = 1 / this.m_motorMass))
    ...
    a.step.warmStarting
        ? ((this.m_impulse *= a.step.dtRatio),
          ...
          (b =
              ...
              this.m_motorImpulse),
          g.SelfMulSub(this.m_invMassA, e),
          (h -= this.m_invIA * d),
          m.SelfMulAdd(this.m_invMassB, e),
          (n += this.m_invIB * b))
...
box2d.b2WheelJoint.prototype.SolveVelocityConstraints = function (a) {
    var b = this.m_invMassA,
        ...
        k =
            -this.m_springMass *
            (k + this.m_bias + this.m_gamma * this.m_springImpulse);
...
box2d.b2WheelJoint.prototype.SolvePositionConstraints = function (a) {
    ...
    var g = box2d.b2MulRV(g, this.m_lalcB, this.m_rB),
        l = box2d.b2AddVV(
            box2d.b2SubVV(e, b, box2d.b2Vec2.s_t0),
            box2d.b2SubVV(g, h, box2d.b2Vec2.s_t1),
...
box2d.b2WheelJoint.prototype.GetReactionForce = function (a, b) {
    b.x =
        a * (this.m_impulse * this.m_ay.x + this.m_springImpulse * this.m_ax.x);
    b.y =
        a * (this.m_impulse * this.m_ay.y + this.m_springImpulse * this.m_ax.y);
    return b;
};
goog.exportProperty(
    box2d.b2WheelJoint.prototype,
...
box2d.b2MotorJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    box2d.b2SubVV(
        ...
        box2d.b2MulRV(k, this.m_linearOffset, box2d.b2Vec2.s_t3),
        this.m_linearError
    );
    ...
    a.step.warmStarting
        ? (this.m_linearImpulse.SelfMul(a.step.dtRatio),
          ...
          e.SelfMulSub(p, b),
          (d -= r * (box2d.b2CrossVV(n, b) + this.m_angularImpulse)),
          h.SelfMulAdd(q, b),
          (l += t * (box2d.b2CrossVV(m, b) + this.m_angularImpulse)))
        : (this.m_linearImpulse.SetZero(), (this.m_angularImpulse = 0));
    ...
    var n = this.m_angularImpulse - p,
        ...
        n = box2d.b2AddVV(
            box2d.b2SubVV(
                box2d.b2AddVV(
                    e,
                    box2d.b2CrossSV(d, t, box2d.b2Vec2.s_t0),
                    box2d.b2Vec2.s_t0
                ),
                box2d.b2AddVV(
                    b,
                    box2d.b2CrossSV(c, r, box2d.b2Vec2.s_t1),
                    box2d.b2Vec2.s_t1
                ),
                box2d.b2Vec2.s_t2
            ),
        ...
        n = box2d
            ...
            .SelfNeg(),
        p =
            box2d.b2MotorJoint.prototype.SolveVelocityConstraints.s_oldImpulse.Copy(
                this.m_linearImpulse
            );
    this.m_linearImpulse.SelfAdd(n);
    q = k * this.m_maxForce;
    this.m_linearImpulse.GetLengthSquared() > q * q &&
...
box2d.b2MotorJoint.prototype.SolveVelocityConstraints.s_impulse =
    new box2d.b2Vec2();
box2d.b2MotorJoint.prototype.SolveVelocityConstraints.s_oldImpulse =
    new box2d.b2Vec2();
