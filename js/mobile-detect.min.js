...
!(function (a, b) {
    a(function () {
        ...
        function c(a, b) {
            for (var c in a) if (o.call(a, c) && a[c].test(b)) return c;
            return null;
        }
        function d(a, b) {
            var c,
        ...
        function i(a, d, e) {
            if (a.mobile === b) {
                var f, g, i;
                return (g = c(m.tablets, d))
                    ? ((a.mobile = a.tablet = g), (a.phone = null), void 0)
                    : (f = c(m.phones, d))
                    ? ((a.mobile = a.phone = f), (a.tablet = null), void 0)
                    : (h(d)
                          ? ((i = k.isPhoneSized(e)),
                            i === b
                                ? (a.mobile = a.tablet = a.phone = r)
                                : i
                                ? ((a.mobile = a.phone = p), (a.tablet = null))
                                : ((a.mobile = a.tablet = q), (a.phone = null)))
        ...
        var l,
            m = {
                ...
                tablets: {
                    ...
                    NexusTablet:
                        "Android.*Nexus[\\s]+(7|10)|^.*Android.*Nexus(?:(?!Mobile).)*$",
                    SamsungTablet:
                    ...
                    GenericTablet:
                        "Android.*\\b97D\\b|Tablet(?!.*PC)|BNTV250A|MID-WCDMA|LogicPD Zoom2|\\bA7EB\\b|CatNova8|A1_07|CT704|CT1002|\\bM721\\b|rk30sdk|\\bEVOTAB\\b|M758A|ET904|ALUMIUM10|Smartfren Tab|Endeavour 1010|Tablet-PC-4|Tagi Tab|\\bM6pro\\b|CT1020W"
                },
                oss: {
                    AndroidOS: "Android",
        ...
        return (
            ...
            (function () {
                ...
                a(m.oss), a(m.phones), a(m.tablets), a(m.uas), a(m.utils);
            })(),
            (k.prototype = {
                constructor: k,
                mobile: function () {
                    return (
                        i(this._cache, this.ua, this.maxPhoneWidth),
                        this._cache.mobile
                    );
                },
                phone: function () {
                ...
                userAgent: function () {
                    return (
                        this._cache.userAgent === b &&
                            (this._cache.userAgent = c(m.uas, this.ua)),
                ...
                os: function () {
                    return (
                        this._cache.os === b &&
                            (this._cache.os = c(m.oss, this.ua)),
                        this._cache.os
                    );
                },
                version: function (a) {
